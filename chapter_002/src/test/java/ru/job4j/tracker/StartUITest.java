...
public class StartUITest {
    ...
    public void whenUserAddItemThenTrackerHasNewItemWithSameName() {
        ...
        new StartUI(input, tracker).init();     //   создаём StartUI и вызываем метод fillActions()
    ...
    public void whenUpdateThenTrackerHasUpdatedValue() {
        ...
        // создаём StartUI и вызываем метод fillActions()
    ...
    public void whenUserAddTwoItemThenTrackerHasNewTwoItemWithPrint() {
        ...
        new StartUI(input, tracker).init();
        final int  expect = 2;
        assertThat(tracker.getAll().length, is(expect));
    }
